---
name: aiskills-multi-agent-patterns
...
|---|---|---|
| Implementation | `aiskills-builder-dev` | Full context, TDD per `aiskills-build-discipline` |
| Code quality | `aiskills-code-reviewer` | Fresh eyes, standards focus (`aiskills-code-review`) |
| Architecture | `aiskills-architect` | Broad system thinking, trade-offs (`aiskills-design`) |
| Security | Security reviewer | Threat-model depth (`aiskills-security-review`) |
| Debugging | Investigator | Log analysis, root-cause discipline (`aiskills-debugging-recovery`) |
...
piece's output. (Canonical mechanics: `aiskills-agentic-loops`, Loop 3.)
...
Stop condition for `aiskills-agentic-loops`'s every piece integrated and the combined verification green.
