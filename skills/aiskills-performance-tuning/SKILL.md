---
name: aiskills-performance-tuning
...
you change code to optimize, load `aiskills-build-discipline` for the how; this skill tells you *what*
to optimize.
...
- Watch saturation trends (`aiskills-observability`'s Golden Signals) — capacity is a forecast, not a reaction.
