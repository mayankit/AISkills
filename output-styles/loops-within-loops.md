...
<!--
  HOST ADAPTER — Claude Code output style.
  ...
  Install:  cp hosts/claude-code-output-style.md ~/.claude/output-styles/loops-within-loops.md
            then run:  /output-style Loops Within Loops
  The installed `aiskills-*` skills still load on demand for depth; this file is the always-on
  spine. You can delete the aiskills brain block from ~/.claude/CLAUDE.md — this supersedes it.
-->
